...
var displayed_stamina = MAX_STAMINA
var desired_stamina = MAX_STAMINA
...
func _ready():
	...
	$stamina_progress.value = MAX_STAMINA
...
func change_color(col=null):
	...
	# Change progress bar colors (they share the same resource)
...
func set_stamina(new_desired):
	displayed_stamina = new_desired
	desired_stamina = new_desired
	$stamina_progress.value = new_desired
...
func set_active(is_active):
	...
	$stamina_icon.visible = is_active
	$stamina_progress.visible = is_active
